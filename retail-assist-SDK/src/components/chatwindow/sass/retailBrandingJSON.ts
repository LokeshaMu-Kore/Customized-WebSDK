const RetailBrandingJSON = {
    ...
    "welcome_screen": {
        ...
        "sub_title": {
            "name": "Hey there! I'm your shopping sidekick here at the Pandora Store."
        },
        "note": {
            "name": ""
        },
        ...
        "starter_box": {
            ...
            "sub_text": "Shop easy: buy,track orders - I've got you!",
            "start_conv_button": {
                "color": "#4B4EDE"
            },
            "start_conv_text": {
            ...
            "quick_start_buttons": {
                ...
                "style": "slack",
                "buttons": [{
                    "title": "I am looking for Rings",
                    "action": {
                        "type": "postback",
                        "value": "I am looking for Rings"
                    }
                },
                {
                    "title": "Show me Charms",
                    "action": {
                        "type": "postback",
                        "value": "Show me Charms"
                    }
                },
                {
                    "title": "Get me my order status",
                    "action": {
                        "type": "postback",
                        "value": "Get me my order status"
                    }
                }
                ],
                "input": "button",
    ...
    "header": {
        ...
        "icon": {
            ...
            "icon_url": "https://retail-assist.s3.amazonaws.com/images/Pandora_Icon.png",
            "type": "custom"
        },
        "icons_color": "#000000",
        "title": {
